        ...
        #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl" 
         ...
         CBUFFER_END   
            ...
            Varyings vert(Attributes v)
            {
                ...
                v.positionOS.xyz += _OutlineWidth *normalize( v.positionOS.xyz); // normalize(v.normal.xyz);
         ...
         CBUFFER_END  
          ...
          // SAMPLER(sampler_MainTex); 
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half ShadowAtten = SampleShadowmap(shadowCoord, TEXTURE2D_ARGS(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), shadowSamplingData, shadowStrength, false);
